...
var _dateConvert = require("./dateConvert");
var _dateConvertDefault = parcelHelpers.interopDefault(_dateConvert);
...
(0, _flatpickrDefault.default)(imputDatePickerRef, options);
...
function currentDifferenceDate(selectedDates) {
    ...
    if (selectedDates < currentDate) {
        btnStartRef.setAttribute("disabled", true);
        return (0, _notiflixNotifyAio.Notify).failure("Please choose a date in the future");
    }
    timeDifference = selectedDates.getTime() - currentDate;
    formatDate = (0, _dateConvertDefault.default)(timeDifference);
...
function startTimer() {
    ...
    if (secondsRef.textContent <= 0 && minutesRef.textContent <= 0) {
        (0, _notiflixNotifyAio.Notify).success("Time end");
        clearInterval(timerId);
    } else {
        formatDate = (0, _dateConvertDefault.default)(timeDifference);
        renderDate(formatDate);
...
function renderDate(formatDate1) {
    secondsRef.textContent = formatDate1.seconds;
    minutesRef.textContent = formatDate1.minutes;
    hoursRef.textContent = formatDate1.hours;
    daysRef.textContent = formatDate1.days;
}

},{"flatpickr":"llQu5","./dateConvert":"j9FF0","notiflix/build/notiflix-notify-aio":"eXQLZ","flatpickr/dist/flatpickr.min.css":"eVN6V","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"llQu5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"j9FF0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
